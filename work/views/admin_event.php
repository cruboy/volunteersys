...
<div class=containertitle><b>活动管理</b>
<?php if(isset($_GET['active_del'])):?><span class="actived">删除活动成功</span><?php endif;?>
<?php if(isset($_GET['active_hide_n'])):?><span class="actived">发布活动成功</span><?php endif;?>
<?php if(isset($_GET['active_hide_y'])):?><span class="actived">禁用活动成功</span><?php endif;?>
...
<form action="page.php?action=operate_page" method="post" name="form_page" id="form_page">
  <table width="100%" id="adm_comment_list" class="item_list">
	...
	'<a href="'.$navibar[$value['gid']]['url'].'" target="_blank" title="查看活动"><img src="./views/images/vlog.gif" align="absbottom" border="0" /></a>';
	?>
     <tr>
...
<div style="margin:20px 0px 0px 0px;"><a href="page.php?action=new">新建活动+</a></div>
...
function pageact(act){
	if (getChecked('ids') == false) {
		alert('请选择要操作的活动');
		return;}
	if(act == 'del' && !confirm('你确定要删除所选活动吗？')){return;}
	$("#operate").val(act);
	$("#form_page").submit();
}
$("#menu_ae").addClass('sidebarsubmenu1');
</script>